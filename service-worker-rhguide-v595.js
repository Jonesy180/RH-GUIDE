const CACHE_NAME='rh-guide-v5.9.5';
const ASSETS=[
  './','./index.html','./style-v595.css?v=595','./manifest.webmanifest?v=rhguide593','./favicon.png',
  ...
  './js/studio-race-flow-v5809.js?v=5829','./js/bootstrap-rhguide-v595.js?v=rhguide595','./js/studio-race-end-v5837.js?v=5837',
