const CACHE_NAME='rhguide-v6.0.71-locked-reset-art';
const ASSETS=[
  ...
  './','./index.html','./style-gt7-v6065.css?v=6065','./style-rhguide-finish-v6068.css?v=6068','./js/gt7-catalogue-v6068.js?v=6068','./style-v595.css?v=6020','./manifest.webmanifest?v=rhguide6068','./favicon.png','./icons/icon-v6068-192.png','./icons/icon-v6068-512.png','./icons/icon-maskable-v6068-192.png','./icons/icon-maskable-v6068-512.png',
...
self.addEventListener('activate',e=>{e.waitUntil(caches.keys().then(keys=>Promise.all(keys.filter(k=>k.startsWith('rh-guide-')&&k!==CACHE_NAME).map(k=>caches.delete(k)))));self.clients.claim();});
