/* rh-guide v6.0.133 — Enter Result targets: TRACK RECORD + YOUR PB.
...
function card(track,layout,carId){
  ...
  return `<section class="rhTrackTargetsRhGuideV6133" aria-label="Race targets"><div><small>TRACK RECORD</small><b>${fmt(t.trackRecord)}</b></div><i></i><div><small>YOUR PB</small><b>${fmt(t.pb)}</b></div></section>`;
}
