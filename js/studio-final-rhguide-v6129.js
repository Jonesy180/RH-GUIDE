// rh-guide v6.0.129 — OTG! v6.0.128 parity with independent guide storage
const RH_FINAL_STORE='RHGuide_OTG_Studio_Final_v2';
...
function rhRenderHome(){
 ...
 $('home').innerHTML=`<div class="rhHome rhHomeLocked rhHomeV4">
   <section class="rhHomeHero rhHomeHeroV4">
     ...
     <img class="rhHomeLogo rhHomeLogoV4" src="assets/brand/otg-approved-painted-mark-v6052.png" alt="Out The Garage! — Drive, Record, Improve">
   </section>
   <main class="rhHomeBody rhHomeBodyV4">
     <div class="rhDashV4List">
       ${row('festival',"show('festival')",'🏁','FESTIVAL','OTG! Championships')}
       ${row('raceoff',"show('raceoff')",'<svg viewBox="0 0 64 64"><path d="M12 14h12v10H12zM12 40h12v10H12zM40 27h12v10H40z"/><path d="M24 19h8v13h8M24 45h8V32"/></svg>','RACE OFF','Knockout Racing')}
       ${row('events',"show('events')",'<svg viewBox="0 0 64 64"><rect x="13" y="15" width="38" height="38" rx="5"/><path d="M22 10v10M42 10v10M21 29h8v8h-8zM35 29h8v8h-8zM21 41h8v8h-8zM35 41h8v8h-8z"/></svg>','CUSTOM RACING','Create Your Own')}
...
function rhRenderEvents(){
 const s=rhSpace(),active=s.customEvents.filter(e=>e.status!=='complete'),hasEvents=active.length;
