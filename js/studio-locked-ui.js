...
/* RaceHub v5.7.2 — Locked Screen Rebuild Candidate
...
window.rhEventResultSummary=function(e,res){
 ...
 ${records?`<div class="rhRecordCelebration"><div class="rhRosettes">${res.championshipRecord?'<b>✹ EVENT RECORD</b>':''}${res.allTime?'<b class="gold">✹ ALL-TIME RACEHUB RECORD</b>':''}</div><img src="assets/final/hubs.png" alt="Hubs"><p>Incredible driving,<br><b>well done!</b></p></div>`:''}
 <button class="btn rhPrimaryWide" onclick="${action}">${label}</button></section>`);
};
...
window.rhAbout=function(){
 ...
 <section class="rhSection"><h2>RACEHUB INFORMATION</h2><div class="rhInfoRow"><span>App Version</span><b>v5.7.2</b></div><div class="rhInfoRow"><span>Data / Backup Version</span><b>v1.0.0</b></div><div class="rhInfoRow"><span>Current RaceHub Space</span><b>${safe(s.name)}</b></div><div class="rhInfoRow"><span>Driver Profile (Global)</span><b>${safe(state.driverName||'Driver')}</b></div></section>
...
<section class="rhSection rhSettingPanel"><button class="rhSettingRow" onclick="rhAbout()"><b>ABOUT RACEHUB</b><span>RaceHub v5.7.2 • ›</span></button></section></div>`};



/* ---- v5.7.2 rebuilt audited components previously spread across older controllers ---- */
