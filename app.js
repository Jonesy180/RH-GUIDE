...
function freshState(){return migrateState({version:'4.3a',cars:[...SEED.cars],events:[...SEED.events],results:[],history:[],recordHistory:[],lastRun:null,currentEventId:'drag',settings:{sound:true,confetti:true,vibrate:true}})}
...
function renderFestival(){
 ...
 const remainingCars=Math.max(0,state.cars.length-completedCars);
...
if('serviceWorker' in navigator){window.addEventListener('load',()=>navigator.serviceWorker.register('./service-worker-v5713.js',{updateViaCache:'none'}).catch(()=>{}));}
