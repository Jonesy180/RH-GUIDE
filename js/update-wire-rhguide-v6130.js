/* rh-guide v6.0.130 — immediate Settings update install/reload */
(()=>{
'use strict';
function currentVersion(){return document.querySelector('meta[name="racehub-version"]')?.content||'6.0.130';}
