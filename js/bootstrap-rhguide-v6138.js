// rh-guide v6.0.138 — preserve established guide state + independent service worker
state=rhLoad();
rhSync();
...
if('serviceWorker' in navigator){window.addEventListener('load',()=>navigator.serviceWorker.register('./service-worker-rhguide-v6138.js',{updateViaCache:'none'}).catch(()=>{}));}
