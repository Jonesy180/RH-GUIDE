// rh-guide v6.0.135 — preserve established guide state + independent service worker
state=rhLoad();
rhSync();
...
if('serviceWorker' in navigator){window.addEventListener('load',()=>navigator.serviceWorker.register('./service-worker-rhguide-v6135.js',{updateViaCache:'none'}).catch(()=>{}));}
