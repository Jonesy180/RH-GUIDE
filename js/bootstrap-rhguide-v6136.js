// rh-guide v6.0.136 — preserve established guide state + independent service worker
state=rhLoad();
rhSync();
...
if('serviceWorker' in navigator){window.addEventListener('load',()=>navigator.serviceWorker.register('./service-worker-rhguide-v6136.js',{updateViaCache:'none'}).catch(()=>{}));}
