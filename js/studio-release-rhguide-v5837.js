/* rh-guide v5.8.37 — update/version authority only. */
(()=>{
 'use strict';
 const CURRENT_VERSION=document.querySelector('meta[name="racehub-version"]')?.content||'5.8.37';
