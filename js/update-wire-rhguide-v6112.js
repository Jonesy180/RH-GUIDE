/* rh-guide v6.0.112 — robust update discovery + install wiring */
(()=>{
'use strict';
function currentVersion(){return document.querySelector('meta[name="racehub-version"]')?.content||'6.0.112';}
