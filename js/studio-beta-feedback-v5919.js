...
/* rh-guide v5.9.19 — authoritative version; universal BACK and form-memory controls retained. */
(()=>{
  'use strict';
  const VERSION=document.querySelector('meta[name="racehub-version"]')?.content||'5.9.19';
  let fieldSerial=0;
