...
function rhRenderHome(){
 ...
 $('home').innerHTML=`<div class="rhHome rhHomeLocked rhHomeV4">
   <section class="rhHomeHero rhHomeHeroV4">
     ...
     <img class="rhHomeLogo rhHomeLogoV4" src="assets/brand/otg-approved-painted-mark-v6052.png" alt="OTG! — Drive, Record, Improve">
   </section>
