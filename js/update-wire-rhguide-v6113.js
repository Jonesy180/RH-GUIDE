/* rh-guide v6.0.113 — robust update discovery + install wiring */
(()=>{
'use strict';
function currentVersion(){return document.querySelector('meta[name="racehub-version"]')?.content||'6.0.113';}
